...
K2preproc <- function(eSet, cohorts = NULL, vehicle = NULL, covariates = NULL, block = NULL, 
    logCounts = FALSE, use = c("Z", "MEAN"), nFeats = nrow(eSet) * 0.02, featMetric = c("sd", 
    ...
    ssGSEAalg = c("ssgsea", "gsva", "zscore", "plage"), ssGSEAminQvalue = 0.01, ssGSEAcores = 0, 
    ...
    K2meta(K2res) <- list(cohorts = cohorts, vehicle = vehicle, covariates = covariates, 
        ...
        ssGSEAminQvalue = ssGSEAminQvalue, ssGSEAcores = ssGSEAcores, oneoff = oneoff, 
