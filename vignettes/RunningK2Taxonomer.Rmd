...
suppressPackageStartupMessages({library('K2Taxonomer')})
```
<p>
...
<br />
**Package version**: `r packageVersion("K2Taxonomer")`
</p>
...
Differential analysis in `r Githubpkg("montilab/K2Taxonomer")` is performed using `r Biocpkg("limma")`. Differential analysis is performed for each partition of the data, comparing the gene expression of each subgroup.
