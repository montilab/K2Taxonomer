...
genesetTable <- function(ENRTABLE, nodeID = NULL, groupID = NULL, dgeHits = NULL){
  ...
  outDT <- datatable(ENRTABLE,
    ...
    formatStyle(c("Direction", "N<br>Gene Set", "Diff<br>ssGSEA"), `border-right` = "solid 2px")
...
genesetTableClusters <- function(ENRTABLE, nodegroupID = NULL, dgeHits = NULL){
  ...
  outDT <- datatable(ENRTABLE,
    ...
    formatRound(c("Mean<br>ssGSEA", "Diff<br>ssGSEA"), digits = 2) %>%
    formatSignif(c("P Value<br>Hyper", "FDR<br>Hyper", "P Value<br>ssGSEA", "FDR<br>ssGSEA"), digits = 2)%>% 
    formatStyle(c("NodeGroup", "N<br>Gene Set", "Mean<br>ssGSEA"), `border-right` = "solid 2px")
